...
[main.py](python)
Displace Cartesian coordinates according to changes in internal coordinates.
- INPUT -
...
- OUTPUT -
  (standard output) : updated Cartesian coordinates in the format of "[atom symbol] [mass] [x] [y] [z]" and convergence info. 
